#!/usr/bin/env bash
# A1 Abl_wo_Dual + A2 Abl_wo_MoE YOLO eval. Shutdown only on full success.
set -euo pipefail
...
infer_one Abl_wo_Dual "$PROJECT/ablation_code/A1_wo_Dual/fusion_gray_infer.py"
infer_one Abl_wo_MoE  "$PROJECT/ablation_code/A2_wo_MoE/fusion_gray_infer.py"
