#!/usr/bin/env python3
"""Build Final_selected.xlsx: Fusion_noleak_1 + 7 baselines, 6 metrics, 3 datasets.

Selection rule (same spirit as LLVIP_MSRS_M3FD_selected_8x6, Full excluded):
among the 7 comparison methods, a metric is kept only if all 7 score worse
than Fusion_noleak_1 on LLVIP, MSRS, and M3FD.
That set is NMI, Qy, MI, VIF, Qabf, VIFF.
"""
...
OUT_XLSX = METRICS_SAVE / 'Final_selected.xlsx'
OUT_COLORED = METRICS_SAVE / 'Final_selected_colored.xlsx'
