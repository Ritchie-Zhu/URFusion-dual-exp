...
INFER_A1="$PROJECT/ablation/Abl_DualMoE_wo_Dual/fusion_gray_infer.py"
INFER_A2="$PROJECT/ablation/Abl_DualMoE_wo_MoE/fusion_gray_infer.py"
...
infer_script_for() {
	case "$1" in
		Abl_DualMoE_wo_Dual) echo "$INFER_A1" ;;
		Abl_DualMoE_wo_MoE) echo "$INFER_A2" ;;
...
need = ['Abl_DualMoE_wo_Dual', 'Abl_DualMoE_wo_MoE']
keep = ['Fusion_noleak_1', 'Abl_DualMoE_wo_Lint', 'Abl_DualMoE_wo_Lgrad', 'Abl_DualMoE_wo_Lbranch']
