...
LOGDIR=/root/autodl-tmp/URFusion-main/vis-ir-gray/train-jobs/console_logs
mkdir -p "$LOGDIR"
...
run_one Abl_wo_Lint --lambda_int 0
run_one Abl_wo_Lgrad --lambda_grad 0
run_one Abl_wo_Lbranch --lambda_branch 0
