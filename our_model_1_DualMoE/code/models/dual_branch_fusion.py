"""
Gray-Y dual-branch fusion F with noisy top-2 MoE.
F fuses Y_vis + IR_gray -> Y_F [B,1,H,W]. No A2V / modulation.
C_gray is used only in training losses (outside this module).
"""
...
class DualBranchFusionNetGray(nn.Module):
	...
	def forward(self, y_vis, ir_gray):
		...
		Returns:
			y_f: [B,1,H,W]
			aux: dict with MoE + branch features (for losses / logging)
		"""
