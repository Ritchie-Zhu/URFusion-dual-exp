...
# Order: MSRS, M3FD, LLVIP. Outputs under our_model_3_SpatialResMoE_2.
...
ROOT=$PROJECT/our_model_3_SpatialResMoE_2
CODE=$ROOT/code
...
V3_ROOT=$PROJECT/our_model_2_SpatialResMoE/eval_save
...
eval_one() {
	...
	local s1=$S1_ROOT/Abl_SpatialResMoE_wo_Res_${dataset}/metrics_summary.json
	if [[ -f "$s1" ]]; then
