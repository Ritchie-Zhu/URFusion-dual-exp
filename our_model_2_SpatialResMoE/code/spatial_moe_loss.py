...
def compute_spatial_moe_loss(
	...
	g = aux['g']
	# One spatial map: compare channel-mean C gradients (same rule as L_main, not 64-ch mush).
	...
	# BCE-with-logits does not vanish when sigmoid saturates (L1(g,mask) did in v2).
