"""Spatial residual MoE: always-on base + vis/ir unique residual experts."""
...
class SpatialResidualMoE(nn.Module):
	...
	def forward(self, f_vis, f_ir):
		...
		# Router is taught only by L_route (BCE-with-logits). Fusion losses
		# must not drive g; mix uses a detached, floored gate.
