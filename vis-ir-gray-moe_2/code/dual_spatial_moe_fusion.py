"""Gray-Y dual PreNet + leak-free spatial residual MoE + PostNet."""
...
from spatial_res_moe import SpatialResidualMoE


class DualSpatialResMoENetGray(nn.Module):
	def __init__(self, feat_channels=64):
		...
		self.moe_block = SpatialResidualMoE(feat_channels=feat_channels)
