...
ROOT=$PROJECT/vis-ir-gray-moe_3
CODE=$ROOT/code
...
MOE2_ROOT=$PROJECT/vis-ir-gray-moe_2/eval_save
...
eval_one() {
	...
	compare_one "$dataset" vs_S1 "$EXP" S1 "$S1_ROOT/Abl_SR_wo_Res_${dataset}/metrics_summary.json"
	compare_one "$dataset" vs_A2 "$EXP" A2 "$A2_ROOT/Abl_wo_MoE_${dataset}/metrics_summary.json"
