"""Train A2 (Abl_wo_MoE): dual PreNet + single expert. lambda_aux defaults to 0."""
...
def parse_args():
	parser = argparse.ArgumentParser(description='A2: dual PreNet + single expert (Abl_wo_MoE)')
	parser.add_argument('--device', type=int, default=0)
	parser.add_argument('--experiment', default='Abl_wo_MoE')
