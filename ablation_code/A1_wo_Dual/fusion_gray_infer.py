"""Gray-Y inference for A1 (Abl_wo_Dual / shared PreNet + MoE)."""
...
def parse_args():
	...
	parser.add_argument('--experiment', type=str, default='Abl_wo_Dual')
	parser.add_argument('--ckpt_root', type=str, default=os.path.join(PROJECT, 'vis-ir-gray/train-jobs/ckpt'))
